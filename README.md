...
<a href="https://www.npmjs.com/package/@emiplegiaqmnpm/beatae-corrupti-sequi"><img alt="npm version" src="https://badge.fury.io/js/@emiplegiaqmnpm/beatae-corrupti-sequi.svg"></a>
<a href="https://npmjs.org/package/@emiplegiaqmnpm/beatae-corrupti-sequi"><img alt="Downloads" src="http://img.shields.io/npm/dm/@emiplegiaqmnpm/beatae-corrupti-sequi.svg"></a>
[![Build Status](https://travis-ci.org/mosch/@emiplegiaqmnpm/beatae-corrupti-sequi.svg?branch=master)](https://travis-ci.org/mosch/@emiplegiaqmnpm/beatae-corrupti-sequi)
[![Design](https://contribute.design/api/shield/mosch/@emiplegiaqmnpm/beatae-corrupti-sequi)](https://contribute.design/mosch/@emiplegiaqmnpm/beatae-corrupti-sequi)
...
Just use your favorite package manager to add `@emiplegiaqmnpm/beatae-corrupti-sequi` to your project:

```sh
yarn add @emiplegiaqmnpm/beatae-corrupti-sequi

npm i --save @emiplegiaqmnpm/beatae-corrupti-sequi

pnpm add @emiplegiaqmnpm/beatae-corrupti-sequi
```

## [Demo](https://@emiplegiaqmnpm/beatae-corrupti-sequi.netlify.com/)
...
import AvatarEditor from '@emiplegiaqmnpm/beatae-corrupti-sequi'
...
drag and drop support to anything really easy. Here is an example how to use it with @emiplegiaqmnpm/beatae-corrupti-sequi:
